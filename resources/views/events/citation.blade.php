...
<div class="mainer">
	<div class="slid">
		<img src="{{asset('assets/img/galerie/gal27.jpg')}}" alt="image" class="image">
		<div class="bout">
...
<script>
	...
	var images = ["{{asset('assets/img/galerie/INVESTISSEMENT.jpg')}}","{{asset('assets/img/galerie/mot2.jpg')}}","{{asset('assets/img/galerie/mot3.jpg')}}","{{asset('assets/img/galerie/mot4.jpg')}}","{{asset('assets/img/galerie/mot5.jpg')}}","{{asset('assets/img/galerie/mot6.jpg')}}"];
	var num = 0;
