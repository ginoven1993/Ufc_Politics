...
<div class="mainer">
	<div class="slid">
		<img src="{{asset('assets/img/galerie/gal15.jpg')}}" alt="image" class="image">
		<div class="bout">
...
<script>
	...
	var images = ["{{asset('assets/img/galerie/gal15.jpg')}}","{{asset('assets/img/galerie/gal18.jpg')}}","{{asset('assets/img/galerie/gal19.jpg')}}","{{asset('assets/img/galerie/gal29.jpg')}}"];
	var num = 0;
