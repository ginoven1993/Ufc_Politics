...
@section('content')
    ...
    <div class="mainer">
        <div class="slid">
            <img src="{{asset('assets/img/galerie/gal9.jpg')}}" alt="image" class="image">
            <div class="bout">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card service-description" style="margin-top: -5%">
                                <div class="card-body">
                                        <h5 class="card-title">Details Evènements Sociales</h5>
...
<script>
   ...
   var images = ["{{asset('assets/img/galerie/gal9.jpg')}}","{{asset('assets/img/galerie/gal22.jpg')}}","{{asset('assets/img/galerie/gal26.jpg')}}","{{asset('assets/img/galerie/sociale.jpg')}}"];
   var num = 0;
